...
bool isBundledIconName(const QString &name)
{
    static const QSet<QString> names = {
        ...
        QStringLiteral("gdrive-badge-trash"), QStringLiteral("gdrive-file-shortcut"),
        QStringLiteral("gdrive-load-more"), QStringLiteral("gdrive-badge-load-more"), QStringLiteral("image"),
