...
class TelegramFileProviderPlugin final : public QObject, public FileProviderPlugin, public FileActionPlugin, public PluginSettingsUi
{
    Q_OBJECT
...
public:
    ...
    QString preprocessPath(const QString &path) const override;
    QString thumbnailUrlForPath(const QString &path) const override;
