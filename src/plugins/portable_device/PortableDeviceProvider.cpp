...
using PortablePath = PortableDevicePath::ParsedPath;
...
{
    return PortableDevicePath::devicePath(deviceId);
}

QString objectPath(const QString &deviceId, const QString &objectId)
{
    return PortableDevicePath::objectPath(deviceId, objectId);
}

PortablePath parsePortablePath(QString path)
{
    return PortableDevicePath::parse(path);
}

QString normalizedPortablePath(const QString &path)
{
    return PortableDevicePath::normalized(path);
}
