    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            FmIconButton {
                ...
                iconSize: 15
                svgRecolorColor: previewMoveLeftButton.hovered ? Theme.textPrimary : Theme.textSecondary
            ...
            FmIconButton {
                ...
                iconSize: 15
                svgRecolorColor: previewMoveRightButton.hovered ? Theme.textPrimary : Theme.textSecondary
                ToolTip.visible: hovered
            ...
            FmIconButton {
                ...
                Layout.preferredWidth: 24
                Layout.preferredHeight: 22
                iconSource: root.verticalPlacement === "top"
                            ? "qrc:/qt/qml/FM/qml/assets/icons-classic/arrow-down.svg"
                            : "qrc:/qt/qml/FM/qml/assets/icons-classic/arrow-up.svg"
                iconSize: 15
                svgRecolorColor: placementButton.hovered ? Theme.textPrimary : Theme.textSecondary
                ToolTip.visible: hovered
